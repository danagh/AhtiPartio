...
function $translate($STORAGE_KEY, $windowProvider, $translateSanitizationProvider, pascalprechtTranslateOverrider) {
  ...
  this.$get = ['$log', '$injector', '$rootScope', '$q', function ($log, $injector, $rootScope, $q) {
     ...
     *
     * @param {string=} langKey Contains the langKey the iteration shall gallery with. Set to false if you want to
    ...
    if ($loaderFactory) {
      ...
      // Also, if there are any fallback language registered, we gallery
